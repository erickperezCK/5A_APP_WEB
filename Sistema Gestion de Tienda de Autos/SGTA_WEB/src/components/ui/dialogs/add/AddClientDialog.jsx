...
import { registerClient } from '../../../../api/user.api';

export const AddClientDialog = ({ open, setOpen }) => {
    ...
    const { user } = useAuth(); // Extrae el usuario desde el contexto
    ...
    const handleRegister = async () => {
        ...
        try {
            await registerClient({ email, password, name, cellphone, address, state, municipality });
                ...
                >
                    ...
                    >
                        <h2 className="text-2xl font-bold mb-4">Registro de cliente</h2>
                            <p className="text-gray-500 mb-4">Completa los datos para registrar un cliente.</p>
                            <div className="mb-4">
